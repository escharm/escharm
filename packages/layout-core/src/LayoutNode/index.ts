...
class LayoutNode {
  ...
  private addPanelNode(data: AddPanelData) {
    ...
    if (oldLayout == null) {
      throw new Error("old layout is null");
    }
  ...
  private removePanelNode(data: RemovePanelData) {
    ...
    if (panelNode == null) {
      throw new Error("panelNode is null");
    }
