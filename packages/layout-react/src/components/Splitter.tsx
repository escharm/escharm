import { LAYOUT_DIRECTION } from "@escharm/layout-core";
import clsx from "clsx";
import { useMemo } from "react";

import { useLayout,useSplitter } from "../features";
import { useSplitterRef } from "../hooks";
import { SplitterCMPT } from "../types";
...
const Splitter: SplitterCMPT = (props) => {
  ...
  const transform = useMemo(() => {
    const x = parent?.direction === LAYOUT_DIRECTION.ROW ? movingOffset : 0;
    const y = parent?.direction === LAYOUT_DIRECTION.ROW ? 0 : movingOffset;
